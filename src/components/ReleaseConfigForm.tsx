...
const ReleaseConfigForm = () => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      {/* Área de Logs - Agora abaixo do botão de publicação */}
      {showLogs && (
        <div className="mt-6 animate-fade-in">
          ...
          <ScrollArea className="bg-[#1A1A1A] border border-playstore-separator rounded-md h-60 p-4 font-mono text-sm">
          ...
          <div className="mt-4 flex justify-end">
            <button 
              className="bg-[#333333] hover:bg-[#444444] text-white px-3 py-1.5 text-sm rounded-md transition-colors flex items-center space-x-2"
              onClick={() => {
